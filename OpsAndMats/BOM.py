...
#        self.dwgindex.drop(columns = "MODEL", inplace=True)
    ...
    def makeItemRecommendation(self, **kwargs):
        ...
        recommendation = {'Item': "", 'DESCRIPTION': "", 'Long Description': "", 'Revision': "", 'Revision Track': 0, 'ECN': 0,
                          ...
                          'PO Tolerance Under': "", 'Kit': 0, 'Print Kit Components on Customer Paperwork': 0, 'Std Due Period': "",
        ...
        if key == "Item":
            ...
            if itemIsDWG:
                ...
                if type(dwgInfo) == pd.Series:
                    ...
                    recommendation['Long Description'] = dwgInfo['TITLE']
                ...
                recommendation['Long Description'] = hardwareInfo
                ...
                recommendation['Long Description'] = wireInfo
                recommendation['Source'] = "Purchased"
                ...
                recommendation['Long Description'] = cableInfo
                recommendation['Source'] = "Purchased"
                recommendation['U/M'] = "IN"
            else:
                recommendation['Item'] = itemSearch
            ...
            recommendation['Long Description'] = "Unknown"
